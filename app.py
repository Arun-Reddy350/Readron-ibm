...
def generate_response(prompt, conversation_history, file_content):
    system_prompt = (
        "You are a helpful assistant. Answer the user's questions about the document. "
        "Do not comment on the conversation structure or say things like 'It appears that...'. "
